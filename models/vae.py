...
class AutoEncoder(ContinualLearner):
    ...
    def train_a_batch(self, x, y=None, x_=None, y_=None, iters=None, scores_=None, tasks_=None, rnt=0.5,
        ...
        # if task > 1:
        #     print(f'-- {loss_total} = {loss_replay} + {loss_cur} or {rnt}*{loss_cur}+(1-{rnt})*{loss_replay} --')
